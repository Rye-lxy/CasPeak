...
if __name__ == "__main__":
    ...
    peak_parser.add_argument("--genome-maf", required=True, metavar="MAF", help="alignment to the genome (required)")
    peak_parser.add_argument("--insert-maf", required=True, metavar="MAF", help="alignment to the insertion sequence (required)")
    peak_parser.add_argument("--bedtools-genome", metavar="GENOME", help="genome data for bedtools")
    ...
    peak_parser.add_argument("--anno", metavar="FILE", help="insertion annotation rmsk file on the reference genome generated by RepeatMasker")
    ...
    exec_parser.add_argument("--bedtools-genome", metavar="GENOME", help="genome data for bedtools")
    exec_parser.add_argument("--anno", metavar="FILE", help="insertion annotation rmsk file on the reference genome generated by RepeatMasker")
